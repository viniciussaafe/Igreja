...
<body>
    ...
    <div class="linha">
        <h1>Comprovante</h1>
        <h2>Documento</h2>
        <form action="comprovante.php" method="POST" enctype="multipart/form-data">
        ...
        foreach ($files as $file) {
            if ($file != '.' && $file != '..' && !preg_match('/\.txt$/', $file)) {
              ...
              Seu navegador não suporta a tag de vídeo.
                ...
                echo "<form method='POST' action='comprovante.php' onsubmit='return confirmDelete(this);'>
    ...
    <div id="confirmDelete" class="confirm-delete">
        ...
        <form id="confirmDeleteForm" method="POST" action="comprovante.php">
